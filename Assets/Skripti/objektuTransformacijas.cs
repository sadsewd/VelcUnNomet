    ...
    void Update()
    {
        if (objektuSkripts.pedejaisVilktais != null)
        {
            ...
            if (Input.GetKey(KeyCode.DownArrow))
            {
                ...
                {
                    objektuSkripts.pedejaisVilktais.GetComponent<RectTransform>().localScale =
                        new Vector2(objektuSkripts.pedejaisVilktais.GetComponent<RectTransform>().transform.localScale.y - 0.001f,
                    objektuSkripts.pedejaisVilktais.GetComponent<RectTransform>().localScale.x);
                }
